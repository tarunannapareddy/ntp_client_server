...
func (c *ntpClient) start() error {
	...
	delayPlot.Title.Text = "NTP Delay vs Iterations from Cloud Server"
	...
	offsetPlot.Title.Text = "NTP Offset vs Iterations from Cloud server"
...
func (c *ntpClient) sendRequest() (float64, float64, error) {
